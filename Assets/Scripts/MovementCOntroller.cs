...
namespace SpaceShooter
{
    public class MovementCOntroller : MonoBehaviour
    {
        ...
        [SerializeField] private PointerClickHold m_ModileFireSecondary;
        ...
        private void Start()
        {
            if (m_ControlMode == ControlMode.Keyboard)
            {
                ...
                m_ModileFireSecondary.gameObject.SetActive(false);
            }
            ...
            else
            {
                ...
                m_ModileFireSecondary.gameObject.SetActive(true);
            }
        }
        ...
        private void ControlMobile()
        {
            ...
            if (m_ModileFireSecondary.IsHold == true)
